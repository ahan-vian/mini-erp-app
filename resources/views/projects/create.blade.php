            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('project.store') }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_project" id="nama_project" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-ouline" placeholder="Contoh: Pembuatan Website E-Commerce">
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Deskripsi Proyek</label>
                        <textarea name="deskripsi_project" id="deskripsi_project" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:shadow-ouline" placeholder="Jelaskan Detail Proyek ini"></textarea>
                    </div>
